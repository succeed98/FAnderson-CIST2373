        ...
        <script type="text/javascript">
            function handleClick(){
                ...
                if (!(customerId && password)){
                    alert('You must enter a valid Customer ID or Password');
                } else {
                    if(!(/^\d*$/.test(customerId))){
                        alert('Customer ID must be numbers');
                    } else {
                        if (!(parseInt(customerId, 10) >= 3000 && parseInt(customerId, 10) <= 3999)){
                            alert('Customer ID must be beteween 3000 to 3999!');
                        } else {
        ...
        <main> 
            ...
            <div class="main-container">
                ...
                <form name="form" class="card">
                    ...
                    <input type="submit" onClick="return handleClick()" value="Login"/>

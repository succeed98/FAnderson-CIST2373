...
public final class home_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("</header>\n");
      out.write("    // get patient from session\n");
      out.write("    ");
 Patient patient = (Patient)session.getAttribute("patient");
      out.write("\n");
      out.write("    \n");
      out.write("    <div class=\"max-w-4xl flex items-center h-auto lg:h-screen flex-wrap mx-auto my-32 lg:my-0\">\n");
      out.write("        <form action=\"http://localhost:31328/DentalCare/PatientHomeServlet\" method=\"post\" name=\"form\" class=\"w-full lg:w-4/5 rounded-lg lg:rounded-l-lg lg:rounded-r-none shadow-2xl bg-white opacity-65 mx-6 lg:mx-0\">\n");
      ...
      out.write("\" class=\"w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500\" placeholder=\"");
      ...
      out.write("                            <input type=\"email\" name=\"email\" class=\"w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500\" placeholder=\"");
      ...
      out.write("                        <div class=\"flex\">\n");
      out.write("                            <div class=\"w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center\"><i class=\"mdi mdi-email-outline text-gray-400 text-lg\"></i></div>\n");
      out.write("                            <input type=\"text\" name=\"address\" class=\"w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500\" placeholder=\"");
      out.print( patient.getAddr());
      out.write("\">\n");
      out.write("                        </div>\n");
      out.write("                    </div>\n");
      out.write("                </div>\n");
      ...
      out.write("                        <div class=\"flex\">\n");
      out.write("                            <div class=\"w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center\"><i class=\"mdi mdi-email-outline text-gray-400 text-lg\"></i></div>\n");
      out.write("                            <input type=\"text\" name=\"insCo\" class=\"w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500\" placeholder=\"");
      out.print( patient.getInsCo());
      out.write("\">\n");
      out.write("                        </div>\n");
      out.write("                    </div>\n");
      out.write("                </div>\n");

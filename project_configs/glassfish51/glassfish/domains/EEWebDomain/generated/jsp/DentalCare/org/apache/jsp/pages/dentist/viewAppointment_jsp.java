...
public final class viewAppointment_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("           <div class=\"flex flex-col w-full lg:w-4/5 rounded-lg lg:rounded-l-lg lg:rounded-r-none shadow-2xl bg-white opacity-65 mx-6 lg:mx-0>\n");
      ...
      out.write("                          <tr>\n");
      out.write("                            <th scope=\"col\" class=\"text-sm font-medium text-gray-900 px-6 py-4 text-left\">\n");
      out.write("                              #\n");
      out.write("                            </th>\n");
      out.write("                            <th scope=\"col\" class=\"text-sm font-medium text-gray-900 px-6 py-4 text-left\">\n");
      out.write("                              First\n");
      ...
      out.write("                            <td class=\"px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900\">1</td>\n");
      ...
      out.write("                          </tr>\n");
      out.write("                          <tr class=\"bg-white border-b transition duration-300 ease-in-out hover:bg-gray-100\">\n");
      out.write("                            <td class=\"px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900\">2</td>\n");
      out.write("                            <td class=\"text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap\">\n");
      out.write("                              Jacob\n");
      out.write("                            </td>\n");
      out.write("                            <td class=\"text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap\">\n");
      ...
      out.write("                          </tr>\n");
      out.write("                          <tr class=\"bg-white border-b transition duration-300 ease-in-out hover:bg-gray-100\">\n");
      out.write("                            <td class=\"px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900\">3</td>\n");
      out.write("                            <td class=\"text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap\">\n");
      out.write("                              Larry\n");
      out.write("                            </td>\n");
      out.write("                            <td class=\"text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap\">\n");

...
public final class viewAppointment_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("                            </th>\n");
      out.write("                            <th scope=\"col\" class=\"text-xl font-medium text-gray-900 px-6 py-4 text-left\">\n");
      out.write("                              Procedure Code\n");
      out.write("                            </th>\n");
      out.write("                            <th scope=\"col\" class=\"text-xl font-medium text-gray-900 px-6 py-4 text-left\">\n");
      out.write("                              Date\n");
      out.write("                            </th>\n");
      out.write("                            <th scope=\"col\" class=\"text-xl font-medium text-gray-900 px-6 py-4 text-left\">\n");
      out.write("                              Procedure Name\n");
      out.write("                            </th>\n");
      out.write("                            <th scope=\"col\" class=\"text-xl font-medium text-gray-900 px-6 py-4 text-left\">\n");
 ...
 for(int i = 0; i < procedures.counter; i++) {
      out.write("\n");
      out.write("                            <form action=\"http://localhost:31328/DentalCare/UpdateDentistAppointmentServlet\" method=\"post\" name=\"form\" class=\"w-full\">\n");
      out.write("                                <input type=\"text\" name=\"email\" value=\"");
      out.print( patient.getEmail() );
      out.write("\"  class=\"hidden\" placeholder=\"");
      ...
      out.write("\n");
      out.write("                                     <input type=\"text\" name=\"procCode\"  value=\"");
      out.print( procedureArray[i].getProcCode() );
      ...
      out.write("                                    <input type=\"text\" name=\"apptDateTime\"  class=\"w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500\" placeholder=\"");
      out.print( procedureArray[i].getAptDateTime() );
      out.write("\">\n");
      out.write("                                  </td>\n");
      out.write("                                  <td class=\"text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap\">\n");
      ...
      out.write("                                  </td>\n");
      out.write("                                  <td class=\"text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap\">\n");
      out.write("                                      <button class=\"bg-red-400 text-gray-900 hover:bg-green-1000  font-bold py-2 px-4 rounded-full\">\n");
      out.write("                                        Update Appointment\n");
      out.write("                                      </button> \n");
      out.write("                                  </td>\n");
      out.write("                                </tr>\n");
      out.write("                            </form>\n");

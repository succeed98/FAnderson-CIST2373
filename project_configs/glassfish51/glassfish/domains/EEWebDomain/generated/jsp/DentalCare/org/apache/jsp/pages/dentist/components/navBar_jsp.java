package org.apache.jsp.pages.dentist.components;
...
public final class navBar_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("                        <a class=\"flex gap-4 items-center\" href=\"/DentalCare/pages/dentist/home.jsp\" aria-label=\"logo\">\n");
      ...
      out.write("                            <ul class=\"space-y-6 space-x-4 tracking-wide font-medium text-base lg:text-sm lg:flex lg:space-y-0\">\n");
      out.write("                                <li class=\"w-full space-y-2 border-primary/10 dark:border-gray-700 flex flex-col -ml-1 sm:flex-row lg:space-y-0 md:w-max lg:border-l\">\n");
      out.write("                                    <a href=\"/DentalCare/pages/dentist/home.jsp\" class=\"relative flex h-9 ml-auto items-center justify-center sm:px-6 before:absolute before:inset-0 before:rounded-full before:bg-sky-600 dark:before:bg-sky-400 before:transition before:duration-300 hover:before:scale-105 active:duration-75 active:before:scale-95\">\n");
      out.write("                                        <span class=\"relative text-sm font-semibold text-white dark:text-gray-900\">Profile</span>\n");
      out.write("                                    </a>\n");
      out.write("                                </li>\n");
      out.write("                                <li class=\"w-full space-y-2 border-primary/10 dark:border-gray-700 flex flex-col -ml-1 sm:flex-row lg:space-y-0 md:w-max lg:border-l\">\n");
      out.write("                                    <a href=\"/DentalCare/pages/dentist/viewAppointment.jsp\" class=\"relative flex h-9 ml-auto items-center justify-center sm:px-6 before:absolute before:inset-0 before:rounded-full before:bg-sky-600 dark:before:bg-sky-400 before:transition before:duration-300 hover:before:scale-105 active:duration-75 active:before:scale-95\">\n");
      out.write("                                        <span class=\"relative text-sm font-semibold text-white dark:text-gray-900\">Appointment</span>\n");
      out.write("                                    </a>\n");
      out.write("                                </li>\n");
      out.write("                            </ul>\n");
      out.write("                        </div>\n");
      ...
      out.write("                            <a href=\"/DentalCare/pages/logout.jsp\" class=\"relative flex h-9 ml-auto items-center justify-center sm:px-6 before:absolute before:inset-0 before:rounded-full before:bg-sky-600 dark:before:bg-sky-400 before:transition before:duration-300 hover:before:scale-105 active:duration-75 active:before:scale-95\">\n");
      out.write("                                <span class=\"relative text-sm font-semibold text-white dark:text-gray-900\">Logout</span>                    \n");
      out.write("                            </a>\n");
      out.write("                        </div>\n");
      out.write("                    </div>\n");
      out.write("                </div>\n");

...
public final class log_005fin_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("                  </div>\n");
      out.write("                <form action=\"http://localhost:31328/DentalCare/LogInServlet\" method=\"post\" name=\"form\">\n");
      ...
      out.write("                        name=\"dentistOrNot\"\n");
      out.write("                        value=\"checked\"\n");
      out.write("                      />\n");
      out.write("                      <label class=\"text-[#48487f] form-check-label inline-block text-gray-800\" for=\"exampleCheck2\"\n");
      out.write("                        >Tick if you are a dentist!</label>\n");
      out.write("                    </div>\n");
      out.write("                  </div>\n");
      out.write("                  <!-- Submit button -->\n");
      out.write("                  <div class=\"w-full px-3 mb-5\">\n");
      out.write("                      <input type=\"submit\" value=\"SIGN IN\" class=\"block w-full max-w-xs mx-auto bg-[#1967d2] hover:bg-[#48487f] focus:bg-indigo-700 text-white rounded-lg px-3 py-3 font-semibold\" />\n");
      out.write("                  </div>\n");
      out.write("                </form>\n");
      out.write("              </div>\n");
      out.write("            </div>\n");
